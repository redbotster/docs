...
**LangSmith Deployment usage** uses a separate data source and start date — see the [Deployment section](#langsmith-deployment-usage-kind-langsmith-deployments) below.
</Note>
